...
from lib_baxter_camera_config import BaxterCamera_Head, BaxterCamera_LeftHand, BaxterCamera_RightHand, form_T, get_Rp_from_T
...
class Object3DPoseLocator(object):
    ...
    def __init__(self,
        ...
        if T_cam_table is None:
            T_cam_table=form_T(R=R_cam_table, p=p_cam_table)
